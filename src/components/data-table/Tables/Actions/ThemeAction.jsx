...
import EditTheme from "../../../CRUD/RegioCentreManager/OffreFormation(Themes)/EditTheme"; // Import EditTheme instead of EditCertification

export const ThemeActions = ({ id }) => {
  // Change prop name to 'id' instead of 'id'
    ...
    <>
      ...
      {open && (
        <Add
          ...
          addAction={(setOpen) => (
            <EditTheme
              id={id} // Pass id prop to EditTheme component
              setOpen={setOpen}
            />
          )}
        />
              ...
              onClick={async () => {
                ...
                try {
                  const response = await ThemeApi.deleteTheme(
                    id, // Pass id to deleteTheme function
                  );
